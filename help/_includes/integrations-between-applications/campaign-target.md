...
Use Adobe [!DNL Campaign] con Adobe [!DNL Target] para personalizar y optimizar el contenido del correo electrónico. Los beneficios clave incluyen:

+ **Datos de Adobe [!DNL Campaign]**: mejore el direccionamiento en Adobe [!DNL Target] con el data mart de Adobe [!DNL Campaign].

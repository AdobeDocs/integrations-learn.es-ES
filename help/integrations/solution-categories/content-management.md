 ...
 <thead>
  ...
  <tbody>
    <tr>
      ...
      <td>
        Cree y supervise plantillas y contenido de marketing por correo electrónico con AEM y
    ...
    <tr>
      ...
      <td>
        Realizar un seguimiento y analizar la eficacia de las imágenes de marketing mediante la integración de
        AEM Assets y Adobe [!DNL Analytics].</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      ...
      <td>
        Coordinar y medir la creación de recursos en una empresa
        mediante la integración de AEM Assets y Workfront.</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      <td>
        Coordinar y medir la creación de recursos en un departamento mediante
        integración de AEM Assets Essentials y Workfront.</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      <td>
        Crear y administrar actualizaciones de recursos en Creative Cloud y Workfront
        aplicaciones</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      ...
      <td>
        Aumentar las capacidades nativas de [!DNL Campaign] para capturar datos de clientes de
        segmentación y personalización de campañas de marketing.</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      ...
      <td>
        Utilizar los datos capturados de los envíos de formularios para la generación de posibles clientes,
        segmentación de clientes y campañas de marketing personalizadas.</td>
      <td>
        <ul style="margin-top: 0;">
          <li>
            Diseñar y publicar formularios dinámicos e interactivos para web y móviles
            dispositivos para la generación de posibles clientes.</li>
        </ul>
      </td>
      <td>
        <a
    ...
    <tr>
      ...
      <td>
        ...
        capacidades de Adobe [!DNL Target].</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      ...
      <td>
        Use segmentos de Audience Manager para crear audiencias en Real-Time CDP para usar
        en tácticas de personalización y remarketing.</td>
      <td>
        <ul style="margin-top: 0;">
          <li>
            Realizar personalización y segmentación de audiencias digitales anónimas en
            el sitio web, la aplicación móvil o en canales publicitarios admitidos</li>
          <li>
            Optimizar la página de aterrizaje y las experiencias de autenticación previa en función de
            características de comportamiento y dispositivo conocidas</li>
          <li>
            Aproveche la red de datos de terceros de Audience Manager para seguir trabajando
            perfeccione y amplíe sus audiencias para la segmentación</li>
    ...
    <tr>
      ...
      <td>
        ...
        utilizar AEM Headless junto con Adobe [!DNL Target].</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      <td>
        ...
        y Adobe [!DNL Target] para personalización.</td>
      <td>
        <ul style="margin-top: 0;">
    ...
    <tr>
      ...
      <td>
        ...
        para personalizar la mensajería en canales web, móviles y otros canales digitales</td>
      <td>
        <ul style="margin-top: 0;">
